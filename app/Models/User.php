...
class User extends Authenticatable implements JWTSubject{
    ...
    public function clues(){
         return $this->belongsToMany('App\Models\Catalogos\Clue');
    }

    public function servicios(){
        return $this->belongsToMany('App\Models\Catalogos\Servicio');
    }

    public function distritos(){
        return $this->belongsToMany('App\Models\Catalogos\Distrito');
    }
    ...
    static function getPermissionsList($usuario){
        ...
        if($usuario->is_superuser){
            ...
            $roles_permisos = User::with('roles.permissions','permissions', 'clues')->find($usuario->id);
            ...
            foreach ($roles_permisos->clues as $clue) {
                if(!isset($clues[$clue->id])){
                    $clues[$clue->id] = $clue->id;
                }
            }
        }
