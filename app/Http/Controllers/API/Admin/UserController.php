...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        try{
            ...
            if($resultado->passes()){
                ...
                $usuario->clues()->sync($clues);
                $usuario->servicios()->sync($servicios);
                $usuario->distritos()->sync($distritos);
    ...
    {
        return response()->json(['data'=>User::with('roles','permissions','clues','servicios','distritos')->find($id)],HttpResponse::HTTP_OK);
    }
