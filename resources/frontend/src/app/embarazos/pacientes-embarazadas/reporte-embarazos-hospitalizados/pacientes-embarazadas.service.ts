...
export class PacientesEmbarazadasService {
  
  url_pacientes_embarazadas       = `${environment.base_url}/reporte-embarazos-hospitalizados`;
  url_catalogos                   = `${environment.base_url}/catalogos`;

  constructor(private http: HttpClient) { }


  getPacientesEmbarazadas(payload): Observable<any> {
